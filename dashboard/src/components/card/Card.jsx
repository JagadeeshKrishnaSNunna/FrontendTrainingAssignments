    ...
    return (
        <React.Fragment>
            <div className='container'>
                <svg widthxmlns="http://www.w3.org/2000/svg" fill="currentColor" className="logo bi bi-person-bounding-box" viewBox="0 0 16 16">
                ...
                <div className="address">
                    <p>
                        ...
                        <span>{props.data.address.street},</span><br />
                        <span>{props.data.address.suite},</span><br />
                        <span>{props.data.address.city},</span><br />
